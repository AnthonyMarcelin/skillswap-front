...
//         </svg>
      ...
      {/* Menu mobile */}
      {open && (
        <nav className="md:hidden bg-primary text-white w-full z-10 absolute left-0 top-20">
          <ul className="flex flex-col items-center gap-4 py-4">
            <li><a href="/" onClick={() => setOpen(false)}>Accueil</a></li>
            <li><a href="/" onClick={() => setOpen(false)}>Se connecter/S'inscrire</a></li>
            <li><a href="/" onClick={() => setOpen(false)}>Mon compte</a></li>
            <li><a href="/" onClick={() => setOpen(false)}>Rechercher</a></li>
          </ul>
        </nav>
      )}
    </header>
